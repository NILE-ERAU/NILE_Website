...
echo "<thead>";
echo "<tr>";
echo "<td width = 10px>Time</td>";
echo "<td width = 10px>Command</td>";
echo "<td>θ (deg)</td>";
echo "<td>R (m)</td>";
echo "<td>Z (m)</td>";
echo "<td>D0</td>";
...
echo "<tbody><tr>";
echo "<td width = 10px><input type='datetime-local' id='timestamp' name='timestamp'></td>";
echo "<td width = 10px><input type='text' id='command' name='command'></td>";
